          ...
          <div className="min-h-screen bg-alt-1">
            ...
            <div className="relative flex flex-grow justify-center">
              <div className="flex flex-col m-1">
                ...
                <Link href={'/faq'} className="m-1 bg-gray-200 md:bg-black md:text-gray-800 lg:text-white hover:text-gray-800 lg:bg-opacity-50 px-10 py-1 rounded md:hover:bg-pink-50 transition-colors shadow-xl backdrop-blur-lg">
                  <div className=" text-2xl lg:bg-opacity-50 rounded">
                    <>Ваши вопросы</>
                  </div>
                </Link>
